...
class Categorias extends Controller {
    ...
    public function index() {
        $this->data['titulo'] = 'Projeto - Categorias';
    ...
    public function add($param1 = '') {
        $this->data['titulo'] = 'Projeto - Novo Categoria';
        if ($param1 != 'new') {
    ...
    public function ler($param1 = '', $param2 = '') {
        $this->data['titulo'] = 'Projeto - Visualizar Categoria';
    ...
    public function editar($param1 = '', $param2 = '', $param3 = '') {
        $this->data['titulo'] = 'Projeto - Editar Categoria';
        if ($param1 != 'read') {
            $obj = $this->post_to_array(array('nome'));
